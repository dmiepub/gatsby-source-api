...
var conflictFieldPrefix = `apidata_`;
...
// Create entities from the few the Data API returns as an object for presumably
// legacy reasons.
...
exports.createGatsbyIds = function (entities) {
  return entities.map(function (e) {
    e.id = uuidv5(e.apidata_id.toString(), uuidv5(`apidata`, seedConstant));
    return e;
  });
};
